# <img src="Source/assets/archane_banner.png" height="30px" width="120px"/>
...
git clone --depth 1 https://github.com/abhidahal/archane ~/archane
cd ~/archane/Scripts
./install.sh
```

> [!TIP]
> You can also add any other apps you wish to install alongside Archane to `Scripts/pkg_user.lst` and pass the file as a parameter to install it like so:
...
To update Archane, you will need to pull the latest changes from GitHub and restore the configs by running the following commands:
...
1. **[Minimal Arch Installation Guide](arch-install.md)**
2. **[After Install Guide](after-install.md)**
3. **[Arcane Keybindings](KEYBINDINGS.md)**

## Contribution Rules

1. **[CONTRIBUTING_INFO](CONTRIBUTING_INFO.md)**
2. **[CONTRIBUTION_GUIDELINES](CONTRIBUTION_GUIDELINES.md)**
